...
describe('Ace', () => {
  ...
  it('should work with a custom strategy', function () {
    ...
    class Strategy {
      constructor (hiThreshold, loThreshold) {
          ...
          case close:
            switch (principal) {
              case sally:
                return true
              case john:
                return securable.balance < this.hiThreshold
              default:
                return securable.balance < this.loThreshold
            }
        }
      }
    ...
    const strategy = new Strategy(hiThreshold, loThreshold)
